...
test.describe('Add family profiles', () => { 
    ...
    test('Add Milo profile (age 4)', async ({ page }) => {
        ...
        await addProfiles(page, 'Milo', '06/12/2021', 'your-email@example.com');
    ...
    test('Add Nora profile (age 8)', async ({ page }) => {
        ...
        await addProfiles(page, 'Nora', '09/23/2017', 'your-email@example.com');
    ...
    test('Add Wolfgang profile (age 12)', async ({ page }) => {
        ...
        await addProfiles(page, 'Wolfgang', '01/07/2014', 'your-email@example.com');
    ...
    test('Add Quinn profile (age 16)', async ({ page }) => {
        ...
        await addProfiles(page, 'Quinn', '11/30/2009', 'your-email@example.com');
